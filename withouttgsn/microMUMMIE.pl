...
my $mummie_path="/data/ohler/Software/microMUMMIE_new/withouttgsn";
...
`cp $UTR_FILE $mummie_path/site.hmm $mummie_path/bg.hmm $mummie_path/peak.hmm $mummie_path/flank-trained.hmm $mummie_path/metamodel.txt $mummie_path/submodels.txt $mummie_path/cons.schema $mummie_path/nocons.schema $mummie_path/make-tgf.pl $mummie_path/hmm-edit $mummie_path/random-HMM $mummie_path/fasta-to-fastb.pl $mummie_path/baum-welch $mummie_path/model-combiner $dir`;
...
`rm -rf chunks PARCLIP.hmm identify.tmp test.gff chunk-preds.gff site.hmm bg.hmm peak.hmm flank-trained.hmm metamodel.txt submodels.txt cons.schema nocons.schema make-tgf.pl hmm-edit random-HMM fasta-to-fastb.pl baum-welch model-combiner filename filename1 filename2 filename3`;
